"""
Django settings for ezi_phishing_detection_system project.
...
ALLOWED_HOSTS = ['localhost', 'ezi-c5fcd8csh8c2bheb.canadacentral-01.azurewebsites.net']  # Allowed hosts for your app
...
INSTALLED_APPS = [
    ...
    'detection',  #  app name
    # Add any other apps you might need
]
...
WSGI_APPLICATION = 'ezi_phishing_detection_system.wsgi.application'  # Replace with your WSGI app
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Corrected the media directory name to 'Media'
